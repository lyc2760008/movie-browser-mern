...
function HighestRate() {
    ...
    const loadMoreItems = () => {
        ...
        endpoint = `${API_URL}movie/top_rated?api_key=${API_KEY}&language=en-US&page=${CurrentPage + 1}`;
        fetchMovies(endpoint);
    ...
    return (
        <div style={{ width: '100%', margin: '0' }}>
            ...
            {User && User && 
                <Title style={{ width: '95%', margin: '1rem auto' }} level={2} > Welcome to Movie Browser, {User}! Top Rated Movies: </Title> }
                <hr />
